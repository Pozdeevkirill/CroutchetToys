...
if(window.screen.width > 1000) {
    ...
    sr.reveal('.delivery_card', {origin: 'top',interval: 400});
    sr.reveal('.arrow', {origin: 'top',interval:500,delay: 600});
}

sr.reveal('.master_title', {origin:'left'});
sr.reveal('.master_discription_text', {origin:'left',delay: 400, interval: 400});

sr.reveal('.minMenu_btn', {origin:'left', interval:400,delay:400});
sr.reveal('.minMenu_media', {origin: 'bottom',interval:400,delay:400});
